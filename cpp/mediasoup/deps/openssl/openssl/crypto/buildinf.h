...
static const char cflags[] = {
    ...
    'D','S','O','_','W','I','N','3','2',' ','-','D','N','D','E','B',
    'U','G',' ','-','D','O','P','E','N','S','S','L','_','T','H','R',
    'E','A','D','S',' ','-','D','O','P','E','N','S','S','L','_','N',
    'O','_','S','T','A','T','I','C','_','E','N','G','I','N','E',' ',
    ...
    'E','N','S','S','L','D','I','R','=','"','\\','"','/','g','/','C',
    'a','n','d','C','+','+','/','M','S','S','e','r','v','e','r','/',
    'w','o','r','k','e','r','/','d','e','p','s','/','o','p','e','n',
    's','s','l','/','o','p','e','n','s','s','l','/','.','.','/','.',
    '.','/','.','.','/','.','.','/','d','e','p','s','/','o','p','e',
    'n','s','s','l','1','.','1','.','0','/','s','s','l','\\','"','"',
    ' ','-','D','E','N','G','I','N','E','S','D','I','R','=','"','\\',
    '"','/','g','/','C','a','n','d','C','+','+','/','M','S','S','e',
    'r','v','e','r','/','w','o','r','k','e','r','/','d','e','p','s',
    '/','o','p','e','n','s','s','l','/','o','p','e','n','s','s','l',
    '/','.','.','/','.','.','/','.','.','/','.','.','/','d','e','p',
    's','/','o','p','e','n','s','s','l','1','.','1','.','0','/','l',
    'i','b','/','e','n','g','i','n','e','s','-','1','_','1','\\','"',
    '"',' ',' ','-','f','P','I','C','\0'
};
#define PLATFORM "platform: mingw64"
#define DATE "built on: Thu Sep 20 23:27:12 2018"
