...
our %config = (
  ...
  defines => [ "DSO_WIN32", "NDEBUG", "OPENSSL_THREADS", "OPENSSL_NO_STATIC_ENGINE", "OPENSSL_PIC", "OPENSSL_IA32_SSE2", "OPENSSL_BN_ASM_MONT", "OPENSSL_BN_ASM_MONT5", "OPENSSL_BN_ASM_GF2m", "SHA1_ASM", "SHA256_ASM", "SHA512_ASM", "RC4_ASM", "MD5_ASM", "AES_ASM", "VPAES_ASM", "BSAES_ASM", "GHASH_ASM", "ECP_NISTZ256_ASM", "PADLOCK_ASM", "POLY1305_ASM" ],
  ...
  openssldir => "",
  options => "-fPIC --prefix=/g/CandC++/MSServer/worker/deps/openssl/openssl/../../../../deps/openssl1.1.0 no-asan no-crypto-mdebug no-crypto-mdebug-backtrace no-ec_nistp_64_gcc_128 no-egd no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl => "/usr/bin/perl",
  perlargv => [ "mingw64", "-fPIC", "--prefix=/g/CandC++/MSServer/worker/deps/openssl/openssl/../../../../deps/openssl1.1.0" ],
  prefix => "/g/CandC++/MSServer/worker/deps/openssl/openssl/../../../../deps/openssl1.1.0",
  processor => "",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cc => "gcc",
  cflags => "-DL_ENDIAN -DWIN32_LEAN_AND_MEAN -DUNICODE -D_UNICODE -m64 -Wall -O3 -D_MT",
